...
/obj/random/tree
	...
	icon_state = "tree1"
	spawn_nothing_percentage = 55
	item_to_spawn()
		return pick(/obj/structure/flora/tree/dead,
...
/obj/random/grass
	...
	spawn_nothing_percentage = 75
	item_to_spawn()
		return pick(/obj/structure/flora/grass/both,
					/obj/structure/flora/grass/green,
					/obj/structure/flora/grass/brown,
					/obj/structure/flora/bush)
...
/obj/random/sovietunder
	...
	desc = "This is a uniform"
	icon = 'icons/mob/uniform.dmi'
	icon_state = "afganka_autumn_var1_s"
	item_to_spawn()
		return pick(/obj/item/clothing/under/coldwar/afganka,
...
/obj/random/usmc
	name = "random us uniform"
	desc = "This is a uniform"
	icon = 'icons/mob/uniform.dmi'
	icon_state = "usmc_green_s"
	item_to_spawn()
		return pick(/obj/item/clothing/under/coldwar/usmc,
