...
/obj/item/clothing/shoes/jungleboots
	name = "jungle boots"
	desc = "A pair of durable brown boots. Waterproofed."
	icon_state = "jungle"
	force = 3
...
/obj/item/clothing/shoes/warm
	name = "warm boots"
	desc = "That's the pair of the warm boots."
	icon_state = "warm"
	force = 3
...
/obj/item/clothing/shoes/khaki
	name = "khaki boots"
	desc = "That's the pair of the khaki military-grade boots."
	icon_state = "khaki"
	force = 4
	armor = list(melee = 15, bullet = 0, laser = 0,energy = 0, bomb = 10, bio = 0, rad = 0)
	cold_protection = FEET
	min_cold_protection_temperature = SHOE_MIN_COLD_PROTECTION_TEMPERATURE
	can_hold_knife = 1

/obj/item/clothing/shoes/steeltoed
	name = "steel-toed boots"
	desc = "That's the pair of the steel-toed military-grade boots."
	icon_state = "steeltoed"
	force = 6
