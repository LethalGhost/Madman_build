...
/material/proc/generate_recipes()
	...
	if(integrity>50)
		...
		recipes += new/datum/stack_recipe("[display_name] one-side barricade", /obj/structure/barricade/oneside, 3, time = 30, one_per_turf = 4, on_floor = 1, supplied_material = "[name]")
