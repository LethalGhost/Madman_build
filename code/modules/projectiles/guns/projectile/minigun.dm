...
////Stationary KORD////
///////////////////////
/obj/item/weapon/gun/projectile/minigun/pkms
	name = "PKMS"
	desc = "That's the Pulemyot Kalashnikova Statsionarniy, a standard-issue HMG used by Soviet Army"
	icon_state = "pkms"
...
/obj/item/weapon/gun/projectile/minigun/pkms/rotate_to(mob/user, atom/A)
	var/shot_dir = get_cardinal_dir(src, A)
	dir = shot_dir
