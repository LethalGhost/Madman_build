...
/datum/reagent/cystamine
	name = "Cystamine"
	id = "cystamine"
	description = "Cystamine is a broad-spectrum anti-radiation drug."
	taste_description = "bitterness"
	reagent_state = LIQUID
	color = "#00A000"
	scannable = 1
...
/datum/reagent/cystamine/affect_blood(var/mob/living/carbon/M, var/alien, var/removed)
	if(alien != IS_DIONA)
		M.drowsyness = max(0, M.drowsyness - 3 * removed)
